...
public class DepartmentController {
	...
	public DepartmentList getDepartments(){
		//receiver.log("deptemp", "In department Service-List All Departments");
	...
	public Department addDepartment(@RequestBody Department department) {
		//receiver.log("deptemp", "In department Service- Add a Department");
	...
	public Department updateDepartment(@RequestBody Department department, @PathVariable int id) {
		//receiver.log("deptemp", "In department Service-Update a Department");
	...
	public String deleteDepartment(@PathVariable int id) {
		//receiver.log("deptemp", "In department Service-Delete a Department");
	...
	public Employee addEmployee(@RequestBody Employee employee) {
		/*
		 * receiver.log("deptemp", "In department Service-Add an Employee");
	...
	public String updateEmployee(@RequestBody Employee employee, @PathVariable int empid) {
		//receiver.log("deptemp", "In department Service-Update an Employee");
	...
	public String deleteEmployee(@PathVariable int id) {
		//receiver.log("deptemp", "In department Service-Delete an Employee");
	...
	public EmployeeList getEmployeeByDeptId(@PathVariable int deptId) {
		/*
		 * receiver.log("deptemp", "In department Service-List All Employees");
