...
public class ClientLogging {
	...
	public void afterAllDepartment() {
		...
		receiver.log("deptemp", "Client,Department Advice:All Department related Operations");
	}
	
	@After("listAllEmployeeAdvice()")
	public void afterAllEmployee() {
		log.info("Employee Advice:All Employee related Operations");
		receiver.log("deptemp", "Client,Employee Advice:All Employee related Operations");
	}
	...
	public Object aroundAdvice(ProceedingJoinPoint proceedingJoinPoint) {
		...
		try {
			...
			receiver.log("deptemp", "Client,before Around Advice: Before Executing the process");
			returnvalue=proceedingJoinPoint.proceed();
			System.out.println("Client,After  Executing around Advice");
			receiver.log("deptemp", "Client,after Around Advice: After Executing the process "+proceedingJoinPoint.toString());
		}
		catch(Throwable e) {
			System.out.println("Client,After throwing");
			receiver.log("deptemp", "Client,After Throwing an Exception");
		}
